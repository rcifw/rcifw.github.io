...
# Support
For a guide to using the CHPC, see [Slurm basics](slurm-basics), and we have a short guide to debugging your scripts in our [debugging fundamentals](debugging-fundamentals) page.
